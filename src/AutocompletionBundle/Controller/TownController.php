...
class TownController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $towns = $em->getRepository('AutocompletionBundle:Town')->findAll();
    ...
    {
        $town = new Town();
        $form = $this->createForm('AutocompletionBundle\Form\TownType', $town);
    ...
    {
        $deleteForm = $this->createDeleteForm($town);
        $editForm = $this->createForm('AutocompletionBundle\Form\TownType', $town);
